	...
	<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="POST">
		...
		<center>
			...
			<%
				...
				int next = DataUtility.getInt(request.getAttribute("next").toString());
			%>
			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label><b>College Name : </b></label> <%=HTMLUtility.getList("collegeId", String.valueOf(bean.getName()), CollegeList)%>&emsp;
